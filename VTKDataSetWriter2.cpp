                              ...
                              vtkm::io::FileType fileType)
{
  ...
  if (coordSystem.IsType<vtkm::cont::ArrayHandleUniformPointCoordinates>())
  {
    ...
    WriteDataSetAsStructuredPoints(
      out, coordSystem.AsArrayHandle<vtkm::cont::ArrayHandleUniformPointCoordinates>(), cellSet, dataSet, fileType);
  }
...
VTKDataSetWriter2::VTKDataSetWriter2(const char* fileName)
  : FileName(fileName)
{
}

VTKDataSetWriter2::VTKDataSetWriter2(const std::string& fileName)
  : FileName(fileName)
{
}

void VTKDataSetWriter2::WriteDataSet(const vtkm::cont::DataSet& dataSet) const
{
...
vtkm::io::FileType VTKDataSetWriter2::GetFileType() const
{
  return this->FileType;
}

void VTKDataSetWriter2::SetFileType(vtkm::io::FileType type)
{
  this->FileType = type;
}
